namespace Application.UseCases.ExternalServices
{
    ...
    public interface ILogBuilder<T>
    {
        ...
        /// <param name="operation">The operation</param>
        /// <returns>The result of operation</returns>
        Operation<T> Information(string message, object entity, ActionType operation);
        ...
        /// <param name="operation">The operation</param>
        /// <returns>The result of operation</returns>
        Operation<T> Warning(string message, object entity, ActionType operation);
        ...
        /// <returns>The result of operation</returns>
        Operation<T> Error(string message, object entity, ActionType operation);
        ...
        /// <param name="operation">The operation</param>
        /// <returns>The result of operation</returns>
        Operation<T> Fatal(string message, object entity, ActionType operation);
    }
}
